...
VALUES
    ...
    ('genshin-impact-build-artefak-dps-terkuat', 'Panduan Rinci Build Artefak & Senjata DPS Terbaik Genshin Impact', 'Panduan Hero', 'Genshin Scholar', '5 menit baca', 3180, '/images/promo/hero-slide-2.svg', 'game5', 'Optimalkan rasio Crit Rate dan Crit DMG karakter utama Anda dengan rekomendasi set artefak dan senjata F2P terbaik.', '<h3>Formula Rasio Emas Crit</h3><p>Untuk memaksimalkan output damage berkelanjutan, pertahankan rasio Crit Rate : Crit DMG sebesar 1:2.</p>'),
    ('bocoran-patch-mobile-legends-season-baru', 'Bocoran Patch Mobile Legends Season Baru: Buff Assassin & Revamp Map', 'Patch Update', 'Moonton Insider', '4 menit baca', 6420, '/images/promo/promo-mlbb.svg', 'game1', 'Rangkuman lengkap perubahan meta jungle, penyesuaian hero marksman, dan pembaruan visual medan tempur Land of Dawn.', '<h3>Kebangkitan Hero Assassin</h3><p>Patch terbaru memberikan peningkatan kecepatan jungling pada hero assassin berbasis energy.</p>'),
    ('tips-hemat-diamond-magic-wheel-legend-skin', 'Trik Hemat Menembus 200 Magic Points Magic Wheel Skin Legend', 'Tips & Trik', 'Admin MPTopUp', '3 menit baca', 4890, '/images/promo/promo-cashback.svg', 'game1', 'Simulasi perhitungan efisiensi draw 5x Magic Wheel dan estimasi total diamond yang dibutuhkan sebelum melakukan gacha.', '<h3>Manfaatkan Diskon Spin 5x</h3><p>Melakukan spin 5x sekaligus jauh lebih hemat karena hanya membutuhkan 270 Diamond/COA.</p>'),
    ('turnamen-esports-komunitas-mptopup-championship', 'MPTopUp Championship 2026: Total Prize Pool 50 Juta Rupiah Terbuka untuk Umum', 'Event Promo', 'Event Organizer', '3 menit baca', 7120, '/images/promo/promo-valorant.svg', 'game1', 'Daftarkan tim squad Anda dalam kompetisi esports MLBB & Valorant tingkat nasional dengan hadiah jutaan rupiah dan voucher diamond.', '<h3>Informasi Pendaftaran Turnamen</h3><p>Kompetisi terbuka bagi seluruh pemain rank Legend ke atas.</p>')
