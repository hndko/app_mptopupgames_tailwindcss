  ...
  <Teleport to="body">
    <div v-if="isOpen" 
      ...
      <div :class="[maxWidthClass || 'max-w-lg']" 
           class="bg-slate-900 border border-slate-800 rounded-3xl w-full p-6 shadow-2xl space-y-4 my-auto relative animate-in fade-in zoom-in-95 duration-150">
        <!-- Header -->
        <div class="flex items-center justify-between border-b border-slate-800 pb-3">
          ...
          <button type="button" @click="$emit('close')" 
                  class="w-8 h-8 rounded-lg hover:bg-slate-800 text-slate-400 hover:text-white flex items-center justify-center transition-colors" 
